...
export type RegressionMethod = 'exponential' | 'linear' | 'logarithmic' | `polynomial-${number}` | 'power' | 'quadratic';
...
type TrendlineOptionsWithDefaults = 'chartTooltips' | 'dimensionExtent' | 'dimensionRange' | 'displayOnHover' | 'highlightRawPoint' | 'lineType' | 'lineWidth' | 'method' | 'opacity' | 'orientation' | 'trendlineAnnotations';
...
export {};
//# sourceMappingURL=trendlineSpec.types.d.ts.map