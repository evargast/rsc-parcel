...
export type ThresholdBackground = {
    thresholdMin?: number;
    thresholdMax?: number;
    fill?: string;
};
...
type BulletOptionsWithDefaults = 'name' | 'metric' | 'dimension' | 'target' | 'color' | 'direction' | 'showTarget' | 'showTargetValue' | 'labelPosition' | 'scaleType' | 'maxScaleValue' | 'track' | 'metricAxis' | 'thresholdBarColor';
...
export {};
//# sourceMappingURL=bulletSpec.types.d.ts.map